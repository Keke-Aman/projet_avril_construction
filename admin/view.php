    ...
    <body>
        <center><h1 class="text-logo"><span class="glyphicon glyphicon-home"></span> Tool's Keke <span class="glyphicon glyphicon-home"></span></h1></center>
         <div class="container admin">
            <div class="row">
               <div class="col-sm-6">
                    <h1><strong>Voir un élément</strong></h1>
                    <br>
                    <form>
                      ...
                      <div class="form-group">
                        <label>Prix:</label><?php echo '  '.number_format((int)$item['price'], 2, '.', ''). ' fcfa';?>
                      </div>
                      <div class="form-group">
                ...
                <div class="col-sm-6 site">
                    <div class="thumbnail">
                        ...
                        <div class="price"><?php echo number_format((int)$item['price'], 2, '.', ''). ' fcfa';?></div>
                          <div class="caption">
